...
class UserTradeInstance {
    ...
    getExportData() { 
        return { 
            ...
            walletBalance: this.walletBalance, dailyGrowthRate: this.metrics.calculateDGR()
        }; 
    }
}
...
<body class="antialiased min-h-screen flex flex-col selection:bg-gray-200">
                        ...
                        <div class="overflow-x-auto max-h-[400px] overflow-y-auto">
                            <table class="w-full text-left text-sm whitespace-nowrap">
                                ...
                                <tbody id="btTableBody" class="font-mono text-xs">
                                    <tr><td colspan="5" class="py-6 text-center text-gray-400 font-sans">No executions triggered.厚<th
                                </tbody>
                            </table>
                        </div>
                    </div>
        ...
        <section id="view-dashboard" class="view-section max-w-[1400px] w-full mx-auto px-4 sm:px-6 py-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                <div class="lg:col-span-8 space-y-8">
                    ...
                    <div class="ui-card p-6 border border-gray-100">
                        <h3 class="text-base font-bold mb-4 flex items-center gap-2 justify-between">
                            ...
                            <span id="dgrDisplay" class="text-xs font-mono font-bold text-green-600 bg-green-50 px-3 py-1 rounded-full">DGR: 0.00%</span>
                        </h3>
                    ...
                    <div class="ui-card p-6 border border-gray-100">
                        ...
                        <div class="space-y-4 mt-2">
                            ...
                            <div class="flex justify-between items-center" title="Contract multiplier per scale step in profit (e.g., 2.0 doubles size).">
                                ...
                                <input type="number" id="profitMultiplierSens" step="0.1" class="input-minimal w-24 py-1.5 text-right font-mono font-bold text-gray-200 bg-gray-50 pointer-events-none" disabled>
                            </div>
                            ...
                            <div class="flex justify-between items-center" title="Maximum contracts allowed for Profit Scaling. Loss DCA is unlimited.">
                                ...
                                <input type="number" id="maxContractsSens" step="1" class="input-minimal w-24 py-1.5 text-right font-mono font-bold text-gray-200 bg-gray-50 pointer-events-none" disabled>
                            </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left text-sm whitespace-nowrap">
                        ...
                        <tbody id="stepHistoryBody" class="font-mono text-xs">
                            <tr><td colspan="5" class="py-10 text-center text-gray-400 font-sans">No active position data found.厚<th
                        </tbody>
                    </table>
                </div>
            </div>
    ...
    <script>
        ...
        async function runBacktest() {
            ...
            if(!res.trades || res.trades.length === 0) { tbody.innerHTML = '<tr><td colspan="5" class="py-6 text-center text-gray-400 font-sans">No executions triggered.厚<th'; return; }
        ...
        async function fetchMetrics() {
                ...
                if (data.activePositions.length > 0 && data.activePositions[0].stepHistory) {
                    ...
                    data.activePositions[0].stepHistory.forEach(s => {
                        ...
                        tbody.innerHTML += '<tr class="border-b border-gray-50 hover:bg-gray-50">' +
                            ...
                            '<td class="py-3 px-2 font-bold ' + (s.type === 'DCA' ? 'text-red-500' : (s.type === 'SCALE' ? 'text-green-500' : 'text-blue-500')) + '">' + s.type + '</td>' +
                    ...
                    tbody.innerHTML = '<tr><td colspan="5" class="py-10 text-center text-gray-400 font-sans">No active position data found.厚<th';
                }
            }
            ...
            document.getElementById("netPnl").className = "text-lg sm:text-xl font-mono font-bold tracking-tight " + ((data.metrics.totalNetPnl || 0) >= 0 ? "text-green-600" : "text-red-600");
